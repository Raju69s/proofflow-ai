...
import { ArrowRight, Image as ImageIcon, Sparkles, MessageSquare, Check, HelpCircle, HardDrive, Smartphone, Zap } from 'lucide-react';
    ...
    <div className="relative overflow-hidden">
      ...
      <section className="relative pt-24 pb-20 md:pt-32 md:pb-28">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-xs font-semibold text-purple-300 mb-6 animate-pulse-slow">
          ...
          <h1 className="font-display font-extrabold text-4xl sm:text-6xl text-white tracking-tight leading-[1.1] mb-6">
            ...
            <span className="text-gradient-primary">Proof, Trust & Marketing.</span>
          </h1>
          
          <p className="max-w-2xl mx-auto text-base sm:text-xl text-slate-300 mb-10 leading-relaxed font-sans">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="/register" className="w-full sm:w-auto">
              <Button variant="primary" className="w-full sm:w-auto py-3 px-8 text-base font-bold gap-2">
                Start Growing Free <ArrowRight size={18} />
              </Button>
            </a>
            <a href="#demo" className="w-full sm:w-auto">
              <Button variant="outline" className="w-full sm:w-auto py-3 px-8 text-base font-medium">
          ...
          {/* Trust badges */}
          <div className="mt-16 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-xs font-semibold text-slate-500 uppercase tracking-widest">
            <span>PLUMBERS</span>
            <span>MOVERS</span>
      ...
      <section id="features" className="py-20 bg-slate-950/40 border-t border-white/5 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card variant="glass" className="p-6">
              <div className="h-12 w-12 rounded-lg bg-purple-500/10 border border-purple-500/20 text-purple-400 flex items-center justify-center mb-6">
                <ImageIcon size={22} />
              </div>
            ...
            {/* Feature 2 */}
            <Card variant="glass" className="p-6">
              <div className="h-12 w-12 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 flex items-center justify-center mb-6">
                <Sparkles size={22} />
              </div>
            ...
            {/* Feature 3 */}
            <Card variant="glass" className="p-6">
              <div className="h-12 w-12 rounded-lg bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 flex items-center justify-center mb-6">
                <Zap size={22} />
              </div>
      ...
      <section id="demo" className="py-20 relative">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <Badge variant="success" className="mb-3">Live Interactive Teaser</Badge>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {['Plumber', 'Electrician', 'Mover', 'Painter'].map((trade) => (
                    <button 
                      key={trade}
                      className="px-4 py-3 rounded-lg text-sm font-medium border border-white/5 bg-slate-900/50 hover:bg-slate-800 text-slate-300 hover:text-white transition-all text-center focus:outline-none focus:border-emerald-500"
                    >
                      {trade}
                    </button>
                  ))}
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-slate-950 border border-white/5 rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-emerald-500"
                />
              </div>

              <div className="pt-2">
                <a href="/register">
                  <Button variant="accent" className="w-full py-3.5 font-bold gap-2">
      ...
      {/* 4. Pricing Matrix */}
      <section id="pricing" className="py-20 bg-slate-950/40 border-t border-white/5">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            <Card variant="glass" className="p-8 border-2 border-emerald-500/30 flex flex-col justify-between h-full relative overflow-hidden shadow-2xl">
              ...
              <a href="/register">
                <Button variant="accent" className="w-full py-3 font-bold shadow-md shadow-emerald-500/10">
                  Upgrade to Pro
                </Button>
              </a>
            </Card>
